...
# Alternatively, to compare only a select number of samples, provide a list with their names
samplelist = c("a_1_fb","a_1_iv") # this must be called samplelist
shared_snv_plot(DF_filt, list = "yes", name = samplelist)
```
By default, this plot asks if the variant is shared across all samples. To 
