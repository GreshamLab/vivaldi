...
* major: major frequnecy nucleotide (>=0.5)
* minor: minor frequnecy nucleotide (<0.5)
...
Here we generate a plot comparing the allele frequency of variants between replicates 1 and 2 *without* removing variants that were only found in one replicate. These are clealry observed as variants that have  zero values along the x or y axes. 
```{r}
